...
def normalize_symptom(symptom):
    ...
    symptom = replacements.get(symptom, symptom)
...
def get_predicted_value(patient_symptoms):
    ...
    # create vector with ALL 132 features
    ...
    for item in patient_symptoms:
        ...
        if item in symptoms_dict:
            ...
            print(f"Symptom not found: {item}")
    ...
    if request.method == 'POST':
        ...
        if predicted_disease == "No matching symptoms found":
            return render_template(
                'index.html',
                message="Symptoms not recognized. Please enter valid symptoms."
            )
